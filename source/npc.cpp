...
void NpcScript::registerFunctions()
{
	...
	lua_register(m_luaState, "selfGetPosition", NpcScript::luaSelfGetPos); //agregado editado por mi entre otros de aqui

	lua_register(m_luaState, "getNpcId", NpcScript::luaGetNpcId);
    lua_register(m_luaState, "doNpcSetCreatureFocus", NpcScript::luaSetNpcFocus);
...
int32_t NpcScript::luaSetNpcFocus(lua_State* L)
{
